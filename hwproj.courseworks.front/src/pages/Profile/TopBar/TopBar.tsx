...
import { Toast, Logotype, TopBar } from "@skbkontur/react-ui";
      ...
      <ModalContext.Consumer>
        {({ openModal }) => (
          <TopBar>
            ...
            <TopBar.End>
              {/* Button position and size are hardcoded. Sorry :( No bad English, please! */}
              {[Roles.Curator, Roles.Lecturer].includes(
                ...
                <div style={{ marginTop: "0.5rem", marginRight: "0.25rem" }}>
                  <Fab
                    ...
                    onClick={() =>
                      openModal("COURSE_WORK_CREATE", {
                        user: this.props.user,
                        onSuccess: this.props.fetchCourseWorks
                      })
                    }
                  >
                    +
              ...
              <div
                onMouseEnter={() =>
                  this.setState({ isAccountTitleHovered: true })
                }
                onMouseLeave={() =>
                  this.setState({ isAccountTitleHovered: false })
                }
